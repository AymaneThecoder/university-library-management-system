...
<head>
    ...
    <link rel="stylesheet" href="http://localhost/management-of-library/public/css/global.css?v=<?= time() ?>">
    <link rel="stylesheet" href="http://localhost/management-of-library/public/css/navbar.css?v=<?= time() ?>">
